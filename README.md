...
## Usage
You can import **songs** either from files locally or, using [yt-dlp](https://github.com/yt-dlp/yt-dlp), from YouTube(or other supported sites).  
...
Each key is represented by two bytes, the first one representing a [ConsoleKey](https://learn.microsoft.com/en-us/dotnet/api/system.consolekey?view=net-10.0)(ck) and the second one a [ConsoleModifiers](https://learn.microsoft.com/en-us/dotnet/api/system.consolemodifiers?view=net-10.0)(cm).  
